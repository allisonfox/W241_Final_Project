...
```{r}
y0 <- rnorm(estimated_sample_size, mean = 0, sd = 5)
tau_male <- rnorm(estimated_sample_size, mean = 2, sd = 5)
tau_female <- rnorm(estimated_sample_size, mean = -1, sd = 5)
tau_old <- rnorm(estimated_sample_size, mean = 5, sd = 5)
tau_facebook <- rnorm(estimated_sample_size, mean = -1, sd = 10) 

experiment_data <- CreateData(estimated_sample_size, y0, tau_male, tau_female, tau_old, tau_facebook)

SimulatePower(experiment_data)
```
